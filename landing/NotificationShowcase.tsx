        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Lolabot doesn't just chat; it analyzes. When a conversation matters, you get a clean, structured email notification with everything you need to know to close the deal or solve the issue.
            </p>
