(function () {
  function mount(options) {
    ...
    var existingLauncher = document.getElementById('lolabot-launcher');
    var existingIframe = document.getElementById('lolabot-iframe');
    if (existingLauncher) existingLauncher.remove();
    if (existingIframe) existingIframe.remove();

    var launcher = document.createElement('button');
    launcher.id = 'lolabot-launcher';
